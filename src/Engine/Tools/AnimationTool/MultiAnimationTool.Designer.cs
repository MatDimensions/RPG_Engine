namespace AnimationTool
{
	partial class MultiAnimationTool
	{
		...
		private void InitializeComponent()
		{
			...
			panelAnim.Location = new Point(3, 59);
			panelAnim.Name = "panelAnim";
			panelAnim.Size = new Size(407, 477);
			...
			// AnimationTimeBox
			// 
			AnimationTimeBox.Location = new Point(107, 30);
			...
			splitContainer1.Panel1.Controls.Add(AnimationTimeBox);
			// 
